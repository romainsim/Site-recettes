...
class Entree
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Reservation::class, mappedBy="entrees")
     */
    private $reservations; // Une entrée peut etre associée à plusieurs réservations
