...
<div id="fh5co-page">
    ...
    <section id="fh5co-hero" class="no-js-fullheight" style="background-image: url(../../images/food_plat.webp);" data-next="yes">
            ...
            <div class="fh5co-intro no-js-fullheight">
                <div class="fh5co-intro-text">
                    ...
                    <div class="fh5co-center-position">
                        <h2 class="animate-box">Nos plats</h2>
                        <h3 class="animate-box">Découvrez nos meilleures recettes de plats, pour bien vous remplir l'estomac!</h3>
