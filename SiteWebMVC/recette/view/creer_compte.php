            ...
            <div class="fh5co-intro js-fullheight">
                <div class="fh5co-intro-text">
                    ...
                    <div class="fh5co-center-position">
                        <form id="creer-compte" method="post" action="../../index.php?action=save">
                            <p><i>Complétez le formulaire. Les champs marqués par </i><em>*</em> sont <em>obligatoires</em></p>
                            <fieldset>
                                <p>
                                    <label for="nomP">Nom<em>*</em> :</label>
                                    <input type="text" id="nomP" name="nom"  />
                                </p>
                                <p>
                                    <label for="prenomP">Prénom<em>*</em> :</label>
                                    <input type="text" id="prenomP" name="prenom" />
                                </p>
                                <p>
                                    <label for="emailP">Email<em>*</em> :</label>
                                ...
                                <p>
                                    <label for="tel">Téléphone<em>*</em> :</label>
                                    <input type="text" id="tel" name="telephone"  />
                                </p>
                                <p class="submit">
                                    <input type="submit" id="btnSubmit" name="account" value="Envoyer" />
                                </p>
                            </fieldset>
                        </form>
                    </div>
