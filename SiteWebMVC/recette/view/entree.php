...
<div id="fh5co-page">
    ...
    <section id="fh5co-hero" class="no-js-fullheight" style="background-image: url(../../images/food_entree.jpg);" data-next="yes">
        <div class="fh5co-overlay"></div>
        <div class="container">
            <div class="fh5co-intro no-js-fullheight">
                <div class="fh5co-intro-text">
                    <div class="fh5co-center-position">
                        <h2 class="animate-box">Nos entrées</h2>
                        <h3 class="animate-box">Découvrez nos meilleures recettes d'entrées pour bien commencer votre repas.</h3>
